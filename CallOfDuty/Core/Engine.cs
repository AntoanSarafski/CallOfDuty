...
namespace CallOfDuty.Core
{
    public class Engine : IEngine
    {
        ...
        private ISoldier GetLieutenantGeneral(
            int id, 
            string firstName,
            string lastName, 
            string[] tokens)
        ...
        private ISoldier GetSpy(int id, string firstName, string lastName, int codeSpy)
            => new Spy(id, firstName, lastName, codeSpy);
